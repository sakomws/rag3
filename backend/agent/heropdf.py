...
def create_pdf(input_data):
    ...
    # Add a title
    pdf.cell(200, 10, 'AWS SOC-2 Compliance Evidences 2023', 0, 1, 'C')
    ...
    file_name = f'/Users/sakom/github/rag3/ui/public/pdfs/financial_report_{started_at}.pdf'
    pdf.output(file_name)
    return f"Report created successfully, file saved as: {file_name}"
